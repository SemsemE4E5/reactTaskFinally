    ...
    <>
      <footer className="footer">
        ...
        <ul className="menu">
          ...
          <li className="menu__item"><a className="menu__link" href="#Courses">Services</a></li>
          <li className="menu__item"><a className="menu__link" href="#About">Team</a></li>
          <li className="menu__item"><a className="menu__link" href="#Contact">Contact</a></li>
        </ul>
        <p>&copy;2021 Programmator | All Rights Reserved</p>
      </footer>
    </>
  );
}
